...
base_path = '/Users/vmirmira/Documents/Ex/Code/march-madness-26/backend/'
...
out.to_csv(base_path + "data/submission.csv", index=False)
...
debug.to_json(base_path + "data/debug_predictions.json", orient="records", indent=2)
# End team name
